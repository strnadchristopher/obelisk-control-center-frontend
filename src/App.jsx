...
// import plex-logo.png from public folder
import plex_logo from '/plex-logo.png'
import hyper_logo from '/hyper-logo.png'


// Import functions from other files
import { connect_to_random_dallas_vpn_server, connect_to_random_us_central_vpn_server, update_statuses, wake_main_pc, manage_service, restart_pi } from './pi-control-center'
...
function App() {
  ...
  return (
    <>
      <h1
        className="Header"
        onClick={() => set_show_hyper_app_link(!show_hyper_app_link)}
  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        <div className="DiskBar">
          <div className={"DiskBarFill" + (resource > 80 ? " RedFill" : "")} style={{ width: `${resource}%` }}></div>
        </div>
      </div>
    </div>
  )
...
function AppModal({ app_name, link, app_icon }) {
  return (
    <a href={link} className="modal AppModal">
